"""
Its best to run this file po on cmd, lalo na po for cui dahil po sa size and to avoid scrolling po. Make sure po the cmd/terminal is big enough to make sure na ma-avoid scrolling.
...
def run_tui():
    ...
    def transfer_tui():
        ...
        if recipient_acc == accounts[current_account_index]['account_number']:
